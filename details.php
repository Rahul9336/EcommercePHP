...
<body>
					...
					<a href="index.php">
						<img  class="img-responsive" src="images/logo.png" alt="logo" id="logo"/></a>
...
<img src='admin/product_images/$pro_image' alt='Product image' width='50%' height='40%'/>
        <h3>$pro_title</h3>
		<p><b>RS:-$pro_price</b></p>
		<p>$pro_desc</p>
		<a href='index.php?pro_id=$pro_id' style='float:left;'>Return</a>

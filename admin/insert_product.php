...
$insert_product="insert into products(product_title,product_brand,product_keywords,product_image,product_cat,product_price,product_desc) values ('$product_title',$product_brand,'$product_keyword','$product_image',$product_category,$product_price,'$product_desc')";
$insert_pro=mysqli_query($con,$insert_product);
if($insert_pro)
{
	echo "<script>alert('poduct has been inserted')</script>";
    echo "<script>window.open('insert_product.php?insert','_self')</script>";
